...
namespace Image {
    ...
    void Create(VK_Renderer::VK_Instance* instance, const VkImageCreateInfo& info, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory);
    ...
    VkImageView CreateView(VK_Renderer::VK_Instance* instance, const VkImageViewCreateInfo& info);
